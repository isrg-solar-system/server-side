...
@section('content')
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="cube col-md-12 mt-3">
                <div class="head">
                    <i class="fa fa-spinner" aria-hidden="true"></i> PERCENT
                    <div class="dropdown">
                        <button class="dropbtn">≡</button>
                        <div class="dropdown-content">
                            <a href="#">Expand</a>
                ...
                <div class="cubecontent plug-cubecontent">
                    <div id="percent" style="width:250px;height:250px;"></div>
